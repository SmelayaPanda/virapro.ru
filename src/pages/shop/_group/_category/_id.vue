          ...
          <!--<el-row type="flex" style="flex-wrap: wrap">-->
            ...
            <!--<el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">-->
              <!--<p id="product_title">-->
                ...
                <!--&lt;!&ndash;<span>&ndash;&gt;-->
                <!--&lt;!&ndash;<v-icon&ndash;&gt;-->
                <!--&lt;!&ndash;v-if="$store.getters.user.favorites[$store.getters.singleProduct.productId]"&ndash;&gt;-->
                <!--&lt;!&ndash;@click.stop="updateOwnProduct($store.getters.singleProduct, 'favorites', 'remove')"&ndash;&gt;-->
                <!--&lt;!&ndash;class="own_product_icon secondary&#45;&#45;text">favorite</v-icon>&ndash;&gt;-->
                <!--&lt;!&ndash;<v-icon&ndash;&gt;-->
                <!--&lt;!&ndash;v-else&ndash;&gt;-->
                <!--&lt;!&ndash;@click.stop="updateOwnProduct($store.getters.singleProduct, 'favorites', 'add')"&ndash;&gt;-->
                <!--&lt;!&ndash;class="own_product_icon primary&#45;&#45;text">favorite_border</v-icon>&ndash;&gt;-->
                <!--&lt;!&ndash;</span>&ndash;&gt;-->
              <!--</p>-->
              <!--<hr>-->
              ...
              <!--<div itemprop="offers" itemscope itemtype="http://schema.org/Offer">-->
                ...
                <!--</p>-->
              <!--</div>-->
              <!--&lt;!&ndash;!$store.getters.user.cart[$store.getters.singleProduct]&ndash;&gt;-->
              <!--<el-button-->
                <!--v-if="true"-->
                <!--id="into_cart_btn"-->
