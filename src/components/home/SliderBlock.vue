      ...
      <transition name="fade">
        <el-row v-if="!hoveredServices && !isSideChanging">
          ...
          <el-col v-if="hoveredProducts && !isSideChanging" :span="18">
            <p class="more_text">
              Сантехника и мебель для дома от лидирующих отечественных и импортных производителей.
              Мы регулярно обновляем ассортимент товаров, чтобы наш каталог был актуален для Клиента.
              Работаем только с популярными и проверенными брендами сантехники
            </p>
          </el-col>
        </el-row>
      </transition>
      ...
      <transition name="fade">
        <el-row v-if="!hoveredProducts && !isSideChanging" class="flex_block">
          ...
          <el-col v-if="hoveredServices && !isSideChanging" :span="18">
            <p class="more_text">
              Широкий спектр услуг по монтажу различного сантехнического оборудования поможет сделать ваш дом тёплым,
              уютным и комфортным. Наши консультанты - команда профессионалов, знающих о сантехнике все. Они подробно
              расскажут о любом изделии, подберут сантехнику по стилю или функционалу, предоставят необходимую
              техническую документацию, дадут рекомендации по уходу и эксплуатации.
            </p>
          </el-col>
        </el-row>
      </transition>
...
<style scoped lang="scss">
  ...
  #rightSide {
    background: linear-gradient(0deg, rgba(9, 118, 212, 0.95), rgba(9, 118, 212, 0.92)), url('~/static/home/services.jpg');
    background-size: cover;
    @include block;
  }
